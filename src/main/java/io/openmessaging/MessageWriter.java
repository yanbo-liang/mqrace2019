...
public class MessageWriter {
    ...
    private ByteBuffer unCompressedHeaderBuffer = ByteBuffer.allocate(messageBatchSize * 4);
    private ByteBuffer compressedHeaderBuffer = ByteBuffer.allocate(messageBatchSize * 4 / 2);
